...
namespace GenericMedicine
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                if (response.ToLower().Equals("y"))
                {
                    ...
                    Carton cartonDetail = objMainProgram.CreateCartonDetail(medicineStripCount, launchDate, retailerAddress, chosenGenericMedicine);
        ...
        public Carton CreateCartonDetail(int medicineStripCount, DateTime launchDate, string retailerAddress, Medicine medicine)
        {
            if (medicine != null)
            {
                ...
                Carton cartonDetail = new Carton()
                {
