    ...
    namespace CartonDetailsTests
{
    ...
    public class CartonTesting
    {
        ...
        {
            Medicine med = obj.CreateMedicineDetail("RH-34983", "23-948903", "carbon iron", DateTime.Parse("12/12/2022"), 2.3);
        ...
        {
            Medicine med = obj.CreateMedicineDetail("Lb-34983", "DL-948903", "carbon iron", DateTime.Parse("12/12/2022"), 2.3); var ex = Assert.Throws<Exception>(() => obj.CreateCartonDetail(medicineStripCount, launchDate, retailerAddress, med));
        ...
        {
            Medicine med = obj.CreateMedicineDetail("ADR-34983", "37-948903", "carbon iron", DateTime.Parse("12/12/2022"), 2.3); var ex = Assert.Throws<Exception>(() => obj.CreateCartonDetail(medicineStripCount, launchDate, retailerAddress, med));
        ...
        [TestCase(8, "12/23/2022", "ghanvinagar-283/abc, Banglore")]
