...
namespace FoodDetailTesting
{
    ...
    class FoodItemTests
    {
        ...
        [TestCase("Cake", 2, "12/12/2022", 72.23)]
        [TestCase("Pizza", 2, "12/10/2022", 300.00)]
        ...
        [TestCase("julli", 2, "12/12/2021", -0.00001)]
        [TestCase("PaniPuru", 2, "12/10/2021", 30)]
        ...
        [TestCase("Icecream", 2, "12/10/2000", 22.22)]
